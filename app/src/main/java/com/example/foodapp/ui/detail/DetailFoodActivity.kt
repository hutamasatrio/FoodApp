...
//        collapsing_toolbar.title = foodDetail?.strMeal.toString()
        Glide.with(this@DetailFoodActivity)
            .load(foodDetail?.strMealThumb)
            .into(mealThumb)
        collapsing_toolbar.title = foodDetail?.strMeal
        category.text = foodDetail?.strCategory
        country.text = foodDetail?.strArea
        instructions.text = foodDetail?.strInstructions
//        dataMeal = foodDetail?
